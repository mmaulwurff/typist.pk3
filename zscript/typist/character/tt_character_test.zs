...
// public: // tt_Clematis //////////////////////////////////////////////////////
  ...
  void TestSuites()
  {
    ...
    {
      let smallANoShift = new("tt_Character").init(tt_Ascii.LowercaseA, false, false);
    ...
    {
      let smallAShift = new("tt_Character").init(tt_Ascii.LowercaseA, true, false);
    ...
    {
      let bigANoShift = new("tt_Character").init(tt_Ascii.UppercaseA, false, false);
    ...
    {
      let bigAShift = new("tt_Character").init(tt_Ascii.UppercaseA, true, false);
    ...
    {
      let numberNoShift = new("tt_Character").init(tt_Ascii.Number4, false, false);
    ...
    {
      let numberShift = new("tt_Character").init(tt_Ascii.Number4, true, false);
      It("Number, shift", Assert(numberShift.getType() == tt_Character.PRINTABLE));
      It("Number, shift", Assert(numberShift.getCharacter() == "4"));
    }

    {
      let backspace = new("tt_Character").init(tt_Ascii.BACKSPACE, false, false);
      It("Backspace", Assert(backspace.getType() == tt_Character.BACKSPACE));
    }

    {
      let nonPrintable = new("tt_Character").init(tt_Ascii.NUL, false, false);
      It("Non-printable", Assert(nonPrintable.getType() == tt_Character.NONE));
    }

    {
      let ctrlBackspace = new("tt_Character").init(tt_Ascii.BACKSPACE, false, true);
      It("Ctrl-Backspace", Assert(ctrlBackspace.getType() == tt_Character.CTRL_BACKSPACE));
    }

    {
      let enter = new("tt_Character").init(tt_Ascii.ENTER, false, true);
