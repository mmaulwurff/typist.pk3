...
// public: // tt_Clematis //////////////////////////////////////////////////////
  ...
  void TestSuites()
  {
    ...
    {
      let smallANoShift = new("tt_Character").init(97, false);
    ...
    {
      let smallAShift = new("tt_Character").init(97, true);
    ...
    {
      let bigANoShift = new("tt_Character").init(65, false);
    ...
    {
      let bigAShift = new("tt_Character").init(65, true);
    ...
    {
      let numberNoShift = new("tt_Character").init(52, false);
    ...
    {
      let numberShift = new("tt_Character").init(52, true);
    ...
    {
      let nonPrintable = new("tt_Character").init(0, false);
